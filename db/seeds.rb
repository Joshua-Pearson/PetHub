...
cody = Animal.create(:name => 'Cody', :species => 'Dog', :breed => "Yellow Lab", :image => "http://humfer.net/yellowlab/yellowlab.jpg", :age => '2', :user_id => 1)
...
stupid = Animal.create(:name => 'Stupid', :species => 'Cat', :breed => "Persian", :image => "http://img4.wikia.nocookie.net/__cb20110301040829/uncyclopedia/images/8/8b/Stupid_cat_3.jpg", :age => '12', :user_id => 3)
